...
class MainActivity : AppCompatActivity(),
    ...
    override fun onOpenItem(open: Bundle) {
        ...
        val fragmentDetail: DetailFragment = DetailFragment.newInstance(
            ...
            open.getString(applicationContext.getString(R.string.email)),
            open.getString(applicationContext.getString(R.string.login)),
            open.getString(applicationContext.getString(R.string.dob)),
            open.getString(applicationContext.getString(R.string.registered)),
            open.getString(applicationContext.getString(R.string.phone)),
            open.getString(applicationContext.getString(R.string.cell)),
            open.getString(applicationContext.getString(R.string.id)),
            open.getString(applicationContext.getString(R.string.picture)),
            open.getString(applicationContext.getString(R.string.nat))
        )
